            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group field-coins-ram_token_addr has-success">
                            <label class="control-label" for="coins-ram_token_addr">充币地址</label>
                            <input type="text" id="coins-ram_token_addr" class="form-control" name="Coins[ram_token_addr]" value="<?= $model->ram_token_addr ?>" aria-invalid="false">
