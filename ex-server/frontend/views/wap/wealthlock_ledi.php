  ...
  <div class="bottom h40" style="height: 100px;">
    ...
    <div class="middle" style="text-align: left;">
      <div class="f14">
        ...
        类型：锁仓<br>
        有效期：365 天<br>
        锁仓金额：<?php echo $usdt_num; ?> USDT
      </div>
    </div>
    <div class="right" style="line-height: 100px;width: 50px;">
      <div class="f14">
        <a style="color: #ffe6ac; font-weight: bold;" href="/wap/order_show_ledi?type=1&access_token=<?php echo $token; ?>">详情</a>
      </div>
    </div>
  </div>
  <hr>
  <div class="bottom h40" style="height: 100px;">
    ...
    <div class="middle" style="text-align: left;">
      <div class="f14">
        ...
        类型：锁仓<br>
        有效期：365 天<br>
        锁仓金额：<?php echo $share_num; ?> USDT
      </div>
    </div>
    <div class="right" style="line-height: 100px;width: 50px;">
      <div class="f14">
        <a style="color: #ffe6ac; font-weight: bold;" href="/wap/order_show_ledi?type=2&access_token=<?php echo $token; ?>">详情</a>
      </div>
    </div>
  </div>
  <hr>
  <div class="bottom h40" style="height: 100px;">
    ...
    <div class="middle" style="text-align: left;">
      <div class="f14">
        ...
        类型：锁仓<br>
        有效期：100 天<br>
        锁仓金额：<?php echo $ldgc_num; ?> LDGC
      </div>
    </div>
    <div class="right" style="line-height: 100px;width: 50px;">
      <div class="f14">
        <a style="color: #ffe6ac; font-weight: bold;" href="/wap/order_show_ledi?type=3&access_token=<?php echo $token; ?>">详情</a>
      </div>
    </div>
  </div>
  <hr>
