...
// fwrite($coin_symbol,json_encode($coin_symbol)."\r\n");
// fwrite($from_address,json_encode($from_address)."\r\n");
// fwrite($to_address,json_encode($to_address)."\r\n");
// fwrite($wallet_memo,json_encode($wallet_memo)."\r\n");
// fwrite($memamounto,json_encode($memamounto)."\r\n");
// fwrite($blockhash,json_encode($blockhash)."\r\n");
// fwrite($txid,json_encode($txid)."\r\n");
// fwrite($memo,json_encode($memo)."\r\n");
// fclose($open);
