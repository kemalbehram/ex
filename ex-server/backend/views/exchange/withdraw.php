                            ...
                            <?php if(count($apply)){ ?>
                                <?php foreach ($apply as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= Url::to(['apply-yes','id'=>$value['id']])?>" class="btn btn-info btn-sm <?= $value['status']!=1?'disabled':'' ?>">自动提币</a>&nbsp;

                                            <a href="<?= Url::to(['apply-yes2','id'=>$value['id']])?>" class="btn btn-info btn-sm <?= $value['status']!=1?'disabled':'' ?>">手工打币</a>&nbsp;                                            
