...
<body>
    <div class="box-all">
      ...
      <div class="container2">
        <div class="f18 yao_title fb">推荐奖励锁仓详情</div>
        <div class="footer">
        </div>
...
<div class="list_reg" style="font-size: 0;">
  ...
  <span class="left" style="width: 20%">推荐人id</span>
  <span class="left" style="width: 29%">金额(USDT)</span>
  <span class="left" style="width: 20%">总/剩余(天)</span>
</div>
</li>
...
<?php $all_num = 0; foreach ($row as $key => $value) {   $all_num = $all_num +   $value['amount'];    ?>
  ...
  <div class="list_reg" style="font-size: 0;">
    ...
    <span class="left" style="width: 20%"><?= $value['uid2']?></span>
    <span class="left" style="width: 29%"><?= $value['amount']?></span>
    <span class="left" style="width: 20%"><?= $value['period']?>/<?= $value['surplus_period']?></span>
  </div>
  </li>
<?php } ?>
...
<div class="tip">
  团队总入金：<?= $team_num?> USDT <br />
  状态：锁仓365天，每日释放0.27%LDGC
</div>
      ...
      <div class="container2">
        <div class="f18 yao_title fb">推荐奖励释放明细</div>
        <div class="footer">
        </div>
<ul class="content_detail weathprofit">
<li v-for="val in regListInfo">
