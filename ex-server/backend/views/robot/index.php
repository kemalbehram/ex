                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach($data as $model){ ?>
                            <tr>
                                ...
                                <td>
                                    <span style="color:<?= $status_color[$model->simulate_status]?>;"><?= $status2[$model->simulate_status]?></span>
                                </td>
                                <td>
                                    <?php if($model->simulate_status == 0){?>
                                        <a href="#" data-id="<?=$model->id?>" class="enable2"><span class="btn btn-info btn-sm">启用</span></a>&nbsp;
                                    <?php }else{?>
                                        <a href="#" data-id="<?=$model->id?>" class="disable2"><span class="btn btn-danger btn-sm">禁用</span></a>&nbsp;
                                    <?php }?>                                    
                                    <a href="<?= Url::to(['simulate','id'=>$model->id])?>""><span class="btn btn-info btn-sm">配置</span></a>&nbsp;
                                </td>
