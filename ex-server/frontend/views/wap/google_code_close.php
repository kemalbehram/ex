    ...
    <div id="box">
        <div class="content content1">
            ...
            <ul class="main">
                <li>
                    ...
                    <div class="footer" onclick="close_open()">關閉</div>
					<div class="info">
        ...
        <div class="content content2">
            ...
            <ul class="main">
                <li>
                    <div class="info">
                        <input type="text" id="google_code" placeholder="請輸入谷歌驗證碼">
                    </div>
                    <div class="footer" style="width: 90%;"  onclick="close_google_code()">確認關閉</div>
                </li>
            </ul>
        </div>
