...
class MemberVerified extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['uid', 'real_name', 'id_number', 'id_card_img', 'id_card_img2', 'id_card_img3', 'ctime'], 'required'],
            [['uid', 'status'], 'integer'],
            [['ctime', 'audit_time'], 'safe'],
            [['real_name', 'id_number'], 'string', 'max' => 100],
            [['id_card_img', 'id_card_img2', 'id_card_img3'], 'string', 'max' => 255],
        ];
    }
