        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-md-4">
                            <p><span style="display: inline-block;min-width: 80px;">ID：</span><?= $user->id ?> <a href="/backend/member/member/change_uinfo?uid=<?= $user->id ?>"> 修改资料</a></p>
                                ...
                                <?php foreach($balance_all as $key => $value){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button id="recharge" type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal" data-coin="<?= $value['name'] ?>" data-addr="<?= $value['addr'] ?>" data-user="<?= $user->id ?>" data-title="锁仓赠币">锁仓赠币</button>

                                            <!-- <a href="<?= Url::to(['coinlock','uid'=>$user['id'],'coin_symbol'=>$value['name']])?>""><span class="btn btn-info btn-sm">锁仓</span></a> -->
                                            <?php if($value['name'] == 'USDT'){ ?>
                                                <!-- <br /> -->
                                                <!-- <a href="<?= Url::to(['coinlock_ledi','uid'=>$user['id'],'coin_symbol'=>$value['name']])?>""><span class="btn btn-info btn-sm">加币直接锁仓</span></a> -->

                                                <!-- <a href="<?= Url::to(['coinlock_ledi_release','uid'=>$user['id']])?>""><span class="btn btn-info btn-sm">释放当天新增业绩的10%</span></a> -->
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
        ...
        <div class="modal-content">
            <form action="<?= Url::to(['update-balance'])?>" method="post" class="form-horizontal" role="form" id="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="" class="control-label col-sm-2 memo_desc">备注</label>
                        <div class="col-sm-10">
...
<script>
    $('#myModal').on('show.bs.modal', function (event) 
    {
        ...
        if (title == '锁仓赠币') {
            modal.find('.type_desc').text('锁仓金额');
            modal.find('.memo_desc').text('锁仓月份');
            modal.find('.change_type').val(31);
        }                    
