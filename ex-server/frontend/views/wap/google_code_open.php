...
<head>
    ...
    <style>
        *{margin:0;padding:0;font-family: pingFang-SC-Regular;list-style: none;font-size: 16px;}
        ...
        .main li input{height:1.14rem;width:100%;background:#f4f4f4;height:1.14rem;top:0;left:0;border: 0px;outline: none;border-radius:0.04rem;text-indent: 1em;font-size: 0.32rem;color:#bdbdbd;}
...
<body>
    <div id="box">
        <div class="content content1">
            ...
            <ul class="main">
                <li>
                    <div class="footer" onclick="get_google_code()">立即開啟</div>
					<div class="info">
                        Google驗證器可以為您的帳戶增加一層保護，當您登入時，在輸入密碼的同時，還需要來自二步驗證的驗證碼
					</div>
                    <div class="info">
                        <!--<a data-v-574295bc="" href="/help?id=24"><p style="color: rgb(18, 150, 219);margin-top: 0px;">如何使用谷歌兩步驗證?</p></a>-->
                    </div>
                </li>
            </ul>
        </div>
            ...
            <ul class="main">
                <li>
                    ...
                    <div class="info">
                        ...
                        <p class="tip wx_fontSize1" style="font-size: 14px;">在上面的16位恢復秘鑰密鑰在安全的地方，遺失秘鑰密鑰將無法恢復兩步驗證</p>
                    </div>
                    <div class="footer" style="width: 90%;"  onclick="confirm()">我已設置並備份密鑰</div>
                </li>
            </ul>
        </div>
        ...
        <div class="content content3">
            ...
            <ul class="main">
                <li>
                    <div class="info">
                        <input type="text" id="google_code2" placeholder="請輸入谷歌驗證碼">
                    </div>
                    <div class="footer" style="width: 90%;"  onclick="open_google_code()">確認</div>
                </li>
            </ul>
        </div>
...
<script type="text/javascript">
    ...
    function open_google_code(){
        var code = $('#google_code2').val();
        if (code == '') {
            Toast('驗證碼不能為空',2000);
            return;
        }
        $.ajax({
            url:"/api/register/confirm-google-check",
            type:"POST",
            data:{
                access_token:token,
                var_code:code,
