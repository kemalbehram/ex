	...
	<div class="content">
		...
		<div class="input-area">
			<div class="shurukuang">
				<input id="mobile_phone" type="text" placeholder="Please enter your email">
			</div>
			<div class="shurukuang">
        ...
        <div style="text-align: right;margin-top: 5px;"><a href="?os=<?php echo $os;?>&code=<?php echo $code;?>" style="color: white;">Phone registration</a></div>
