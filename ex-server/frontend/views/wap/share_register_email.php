	...
	<div class="content">
		...
		<div class="input-area">
			<div class="shurukuang">
				<input id="mobile_phone" type="text" placeholder="请输入邮箱">
			</div>
			<div class="shurukuang">
		...
		<a href="<?= Yii::$app->config->info('APP_DOWNLOAD_URL') ?>" style="color: #fff; padding: 10px 0; width: 100%; margin: 0 auto; display: block; text-align: center; text-decoration: none;">下载App</a>	
	</div>
